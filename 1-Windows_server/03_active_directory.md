...
![Vérification du domaine Active Directory](images/get-addomain.png)
...
![OU créées dans le domaine](images/OU-créé-dans-Domain.png)
...
![Création d’un utilisateur](images/création-utilisateur.png)

Après création, je vérifie qu’il est bien placé dans la bonne OU :

![Utilisateur créé dans son OU](images/user-créé-dans-ou.png)
...
![Ajout d’un utilisateur à un groupe](images/ajt-user-a-grp.png)
